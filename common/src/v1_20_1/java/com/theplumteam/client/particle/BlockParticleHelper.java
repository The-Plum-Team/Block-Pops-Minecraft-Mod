...
public class BlockParticleHelper {
    ...
    private static final ResourceLocation MISSING_CHECK_SPRITE = new ResourceLocation("blockpops", "_missing_particle_");
    ...
    public static boolean spawnBoxDestroyParticles(Level level, BlockPos pos, BoxBlockEntity boxBE) {
        ...
        if (color != null) {
            ResourceLocation colorTexture = new ResourceLocation("blockpops",
    ...
    private static TextureAtlasSprite getSpriteOrNull(ResourceLocation spriteId) {
        ...
        // TextureAtlas.apply() never returns null - it returns the MissingTextureAtlasSprite.
        // Detect missing by comparing with a known-missing sprite reference.
