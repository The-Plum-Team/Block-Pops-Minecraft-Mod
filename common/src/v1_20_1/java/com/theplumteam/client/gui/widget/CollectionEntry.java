...
public class CollectionEntry extends ObjectSelectionList.Entry<CollectionEntry> {
    ...
    private static final ResourceLocation COLLECTION_GLOBE_ICON = new ResourceLocation("blockpops", "textures/gui/search_icon.png");
    ...
    public void render(GuiGraphics graphics, int index, int y, int x, int entryWidth,
        ...
        if (logoTexture != null) {
            ...
            // SODIUM FIX: Flush before logo rendering
            graphics.flush();
            ...
            // SODIUM FIX: Flush after logo rendering
            graphics.flush();
        }
