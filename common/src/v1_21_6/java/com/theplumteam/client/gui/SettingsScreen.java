...
public class SettingsScreen extends Screen {
    ...
    private static final int TITLE_COLOR = 0xFFFFFFFF;          // White title (ARGB)
        ...
        if (activeTab == Tab.SERVER) {
            ...
            if (!admin) {
                ...
                graphics.drawString(this.font, val,
                        contentX + contentWidth - this.font.width(val), labelY, 0xFFAAAAAA);
            }
    ...
    private void rebuildRemoteWidgets() {
        ...
        if (pendingRemoteCollections.isEmpty()) {
            // No collections added yet - nothing to show
        } else {
            int buttonHeight = 24;
            int removeWidth = 24;
            int entrySpacing = 4;
