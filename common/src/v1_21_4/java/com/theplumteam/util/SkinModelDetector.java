...
public class SkinModelDetector {
    ...
    public static SkinModel detectSkinModel(ResourceLocation textureLocation) {
        ...
        try {
            ...
            // Note: HttpTexture was removed in 1.21.4 (replaced by SkinTextureDownloader utility)
            // The resource manager fallback below will handle standard skin textures
