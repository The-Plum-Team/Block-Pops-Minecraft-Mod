...
public class BlockPopsModForgeClient {
    ...
    /**
     * Initialize client-side mod bus event listeners
     */
    public static void initModBusEvents(net.neoforged.bus.api.IEventBus modEventBus) {
        modEventBus.addListener(BlockPopsModForgeClient::clientSetup);
        modEventBus.addListener(BlockPopsModForgeClient::registerRenderers);
        modEventBus.addListener(BlockPopsModForgeClient::registerSpecialModelRenderers);
        modEventBus.addListener(BlockPopsModForgeClient::registerPipRenderers);
        modEventBus.addListener(BlockPopsModForgeClient::registerResourceListeners);
    }
    ...
    public static void registerPipRenderers(RegisterPictureInPictureRenderersEvent event) {
        event.register(FigurePipRenderState.class, bs -> new FigurePipRenderer(bs));
        event.register(ItemPipRenderState.class, bs -> new ItemPipRenderer(bs));
        BlockPopsMod.logDebug("Registered PiP renderers (FigurePipRenderer, ItemPipRenderer)");
    }
