                                ...
                                try {
                                    ...
                                    if (playerDataFile.exists()) {
                                        ...
                                        if (playerData != null) {
                                            ...
                                            CompoundTag cardinalComponents = playerData.getCompoundOrEmpty("cardinal_components");
                                            if (cardinalComponents.contains("blockpops:player_discovery")) {
                                                CompoundTag discoveryTag = cardinalComponents.getCompoundOrEmpty("blockpops:player_discovery");
                                                if (discoveryTag.contains("FavoriteColor")) {
                                                    try {
                                                        favoriteColor = PopBlockColor.valueOf(discoveryTag.getStringOr("FavoriteColor", "").toUpperCase());
